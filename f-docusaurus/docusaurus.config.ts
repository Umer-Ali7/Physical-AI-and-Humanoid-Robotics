...
const config: Config = {
  ...
  themeConfig: {
    ...
    color: {
      primary: '#00f7ff', // Electric Blue / Cyan
      secondary: '#a64de6', // Neon Purple accent
    },
    navbar: {
      ...
      links: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              to: '/docs/module-02-digital-twin/gazebo-setup',
            },
            {
              label: 'Module 3: The AI-Robot Brain',
              to: '/docs/module-03-robot-brain/isaac-sim',
            },
            {
              label: 'Module 4: Vision-Language-Action',
              to: '/docs/module-04-vla/voice-control',
            },
            {
              label: 'Module 5: Capstone Project',
              to: '/docs/module-05-capstone/final-project',
            },
          ],
        },
        {
